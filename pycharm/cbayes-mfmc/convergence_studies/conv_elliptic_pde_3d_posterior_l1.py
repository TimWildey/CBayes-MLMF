...
if __name__ == '__main__':
    ...
    # Monte Carlo
    n_evals_mc = np.logspace(np.log10(50), np.log10(1000), n_grid)
    n_evals_mc = np.round(n_evals_mc).astype(int)

    # MFMC 1lf
    n_evals_mfmc_hf_1lf = np.logspace(np.log10(40), np.log10(300), n_grid)
    ...
    # MFMC 2lf
    n_evals_mfmc_hf_2lf = np.logspace(np.log10(20), np.log10(100), n_grid)
    n_evals_mfmc_hf_2lf = np.round(n_evals_mfmc_hf_2lf).astype(int)
    n_evals_mfmc_mf_2lf = np.logspace(np.log10(30), np.log10(400), n_grid)
    ...
    n_evals_all = np.logspace(np.log10(40), np.log10(1000), 2)
    ...
    plt.grid(b=True)
    plt.gcf().savefig('elliptic_pde_3qoi_posterior_convergence_l1.eps', dpi=300)
    np.save('elliptic_pde_3qoi_posterior_convergence_l1', [l1_posterior_1hf_avg,
