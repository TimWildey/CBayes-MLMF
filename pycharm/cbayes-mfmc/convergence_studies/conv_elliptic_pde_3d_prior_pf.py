...
if __name__ == '__main__':
    ...
    n_evals_mfmc_mf = np.logspace(np.log10(20), np.log10(300), n_grid)
    n_evals_mfmc_mf = np.round(n_evals_mfmc_mf).astype(int)
    n_evals_mfmc_lf = np.logspace(np.log10(200), np.log10(10000), n_grid)
    ...
    total_costs_2lf = (costs_hf + costs_mf) * n_evals_mfmc_hf + (
                costs_mf + costs_lf) * n_evals_mfmc_mf + costs_lf * n_evals_mfmc_lf
